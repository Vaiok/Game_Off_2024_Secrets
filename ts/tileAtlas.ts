...
import { MainCanvas, VisibleCanvas } from './canvas.js';
import { PerlinNoise } from './perlinNoise.js';

type Tile = 'water' | 'grass' | 'mountain';
type SampleLocations = { [key: string]: Position2D };
...
class TileAtlas {
    ...
    private tileAtlas: OffscreenCanvas;
    constructor(canvas: MainCanvas, tileViewRange: number) {
    ...
    private getTileSize(canvas: VisibleCanvas, tileViewRange: number): number {
    ...
    public generateTileAtlas(): AtlasData {
        const samples: SampleLocations = {};
...
export { Tile, SampleLocations, AtlasData, TerrainData, TileAtlas };